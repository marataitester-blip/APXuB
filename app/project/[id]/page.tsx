import { ArrowLeft, Github, Globe, FileText, Activity, Trash2, Edit2 } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            {project.repoUrl && (
              <form action={generatePassportAction}>
                <input type="hidden" name="projectId" value={project.id} />
                <button type="submit" className="flex items-center gap-2 text-sm text-[#0a0a0a] bg-gold px-4 py-2 rounded-lg font-medium hover:bg-gold-light transition-colors">
